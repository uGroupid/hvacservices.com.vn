...
class Admin extends MY_Controller{
	...
	public function index(){
		...
		// print_r($session_all);die;
		redirect("/admin/manager_products");
		$data = array();
	...
	public function catelog(){
		...
		//$loggedIn = $this->session->all_userdata();
			...
			/*Funtion Hkeanginc .VN*/	$xcrud->label('addpem','Danh Mục Gốc');
			...
			/*Funtion Hkeanginc .VN*/	$xcrud->relation('subcate','tbl_danhmuc','id_danhmuc','name_vi','tbl_danhmuc.addpem = 1');
			...
			/*Funtion Hkeanginc .VN*/	$xcrud->relation('addpem','tbl_active','id_active','name');
	...
	public function customer_information(){
		...
		//$loggedIn = $this->session->all_userdata();
			/*Funtion Hkeanginc .VN*/	$xcrud = Xcrud::get_instance();
			/*Funtion Hkeanginc .VN*/	$xcrud->table('tbl_customer_contact');
			/*Funtion Hkeanginc .VN*/	$xcrud->table_name('Thông Tin Khách Hàng');
			/*Funtion Hkeanginc .VN*/	$xcrud->label('fullname','Tên Khách Hàng')->label('email','email');
			/*Funtion Hkeanginc .VN*/	$xcrud->label('phone','phone')->label('timedate','Time');
			/*Funtion Hkeanginc .VN*/	$xcrud->label('message','message');
			$xcrud->unset_add();
			$xcrud->unset_edit();
			$xcrud->unset_csv();
			/*Funtion Hkeanginc .VN*/	$xcrud->columns('fullname,email,phone,timedate,message');
			/*Funtion Hkeanginc .VN*/	$data['menu'] = $xcrud->render();
	...
	public function content(){
		...
		//$loggedIn = $this->session->all_userdata();
			...
			/*Funtion Hkeanginc .VN*/	$xcrud = Xcrud::get_instance();
			/*Funtion Hkeanginc .VN*/	$xcrud->table('tbl_content_service');
			/*Funtion Hkeanginc .VN*/	$xcrud->table_name('Cấu Hình Bài Viết About Us And Service ');
				/*Funtion Hkeanginc .VN*/   $xcrud->no_editor('description')->no_editor('keywords');
			/*Funtion Hkeanginc .VN*/	$xcrud->label('content_vi','Nội Dung Tiếng Việt')->label('content_en','Nội Dung Tiếng Anh');
			/*Funtion Hkeanginc .VN*/	$xcrud->label('keywords','keywords')->label('description','description');
			/*Funtion Hkeanginc .VN*/	$xcrud->label('category_list','Loại Danh Mục')->label('subcate','Danh Mục Con');
			/*Funtion Hkeanginc .VN*/	$xcrud->label('active_menu','Kiểu Menu')->label('active','active');
			/*Funtion Xcrud .VN*/ 		$xcrud->relation('category_list','tbl_danhmuc','id_danhmuc','name_vi');
			...
			/*Funtion Hkeanginc .VN*/	$xcrud->columns('content_vi,content_en,keywords,description,category_list');
			/*Funtion Hkeanginc .VN*/	$data['menu'] = $xcrud->render();
	...
	public function manager_products(){
		...
		/*Funtion Hkeanginc .VN*/	$xcrud->label('content','Nội Dung Slide')->label('name_products_vi','Tên Sản Phẩm Vi')->label('name_products','Tên Sản Phẩm EN')->label('img','Hình Ảnh 1170x700');
		...
		/*Funtion Hkeanginc .VN*/	$xcrud->relation('id_catelog','tbl_danhmuc','id_danhmuc','name_vi','tbl_danhmuc.active_menu = 2');
		/*Funtion Hkeanginc .VN*/	$xcrud->columns('name_products,name_products_vi,img,id_catelog,content,introduction,details,description,keywords');
		/*Funtion Hkeanginc .VN*/	$data['slideshow'] = $xcrud->render();
...
// 	}
	...
	public function user(){
			...
			//}
			/*Funtion Hkeanginc .VN*/	$xcrud->table_name('Quản Lý User');
			/*Funtion Hkeanginc .VN*/	$xcrud->relation('id_pem','tbl_pemuser','id_pem','name_pem');
			/*Funtion Hkeanginc .VN*/	$xcrud->label('nameuser','Tên Đăng Nhập')->label('id_pem','Quyền Hạn')->label('passwords','Mật Khẩu');
			/*Funtion Hkeanginc .VN*/	$xcrud->validation_required('nameuser')->validation_required('passwords')->validation_required('id_pem');
			/*Funtion Hkeanginc .VN*/ 	$xcrud->change_type('passwords', 'password', 'md5', array('maxlength'=>10,'placeholder'=>'Nhập Mật Khẩu Của Bạn'));
			/*Funtion Hkeanginc .VN*/	$xcrud->columns('nameuser,passwords,id_pem');
