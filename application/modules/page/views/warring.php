									...
									<ul class="sliders">
										...
										<div class="slide-caption">
											<div class="slide-caption-info">
												<h3><a href="#"></a><small><?php echo $valueslide['title'];?></small></h3>
						...
						<div class="noo-vc-col col-md-12 ">
							<div class="container-boxed max">
								<div class="noo-vc-row row " style=" padding-top: 20px; padding-bottom: 20px;">
									<div class="noo-vc-col col-md-12 ">
											<span> Chúng Tôi Xin Lỗi Vì Không Có Trang Này! Hoặc Bạn Đang Cố Tình Phá Hoại Website! Vui lòng Trở về Trang Chủ</span>
									</div>
								</div>
							</div>
						</div>
