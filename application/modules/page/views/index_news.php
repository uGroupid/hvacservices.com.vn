					 ...
					 ?>
						...
						<div class="content-wrap">
							...
							<p class="content-meta">
								<span>
								Posted in <a href="<?php echo base_url().uri_string();?>" title="Quat Gio Cong Nghiep">Favevietnam.com</a></span>
								<span>
                      ...
                      <?php if($news['img'] == ''){ ?>
                        <img src="http://favevietnam.com/themes/wp-content/uploads/2014/09/logo.jpg" width="500" height="281"></img>
                      <?php  }else{ ?>
