...
{
    // default connection
    public static $dbname = 'c2db1'; // Your database name
    public static $dbuser = 'c2db1'; // Your database username
    public static $dbpass = '!kSPm6mbGFxJ'; // // Your database password
    ...
    // print
    public static $print_all_fields = true; // print all fields and rows of table or only visible.
