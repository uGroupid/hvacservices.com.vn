									...
									<?php $groupproduct = $this->callbuyMD->group_products();
										...
										<div class="recent-properties recent-properties-featured">
											<div class="recent-properties-title">
												 <span class="property-category"><h4><a href="<?php echo base_url();?>page/product/<?php echo $value_list_products['id_danhmuc'];?>"><u>
												 <img style="width: 10%;" class="noo-logo-retina-img noo-logo-normal" src="<?php echo base_url() ?>img/log1.png" alt="QUẠT CÔNG NGHIỆP">  <?php echo $value_list_products['name_en'];?></u></a></h4></span>
											</div>
