									...
									<?php $groupproduct = $this->callbuyMD->group_products();
										...
										<div class="recent-properties recent-properties-featured">
											<div class="recent-properties-title">
												 <span class="property-category"><h4><a href="<?php echo base_url();?>vn/page/product/<?php echo $value_list_products['id_danhmuc'];?>"><u style="font-size:2em"><img style="width: 150px; height: 40px;"  class="noo-logo-retina-img noo-logo-normal" src="<?php echo base_url() ?>img/log1.png" alt="QUẠT CÔNG NGHIỆP">  <?php echo $value_list_products['name_vi'];?></u></a></h4></span>
											</div>
													...
													<ul>
														...
														<li>
															...
															<div class="property-featured">
																...
																<img width="300px" height="400px" src="<?php echo base_url() ?>assets/uploads/<?php echo  $value_productsnew['img'];?>" class="" alt="<?php echo  $value_productsnew['name_products_vi'];?>"/></a>
															</div>
															<div class="property-wrap">
																<h2 class="property-title">
																<a href="<?php echo base_url();?>vn/page/detail/<?php echo $value_productsnew['id_products'];?>" title="<?php echo  $value_productsnew['name_products_vi'];?>"><?php   echo mb_substr($value_productsnew['name_products_vi'],0,75,'UTF-8');?></a>
																</h2>
																...
																<div class="property-summary">
																	...
																	<div class="property-info">
																		<div class="property-action">
																			<a id="clickdowload" class="button" href="#popup1">Tải Về Danh Mục  <i class="fa fa-arrow-circle-o-right"></i>
																			</a>
																		</div>
																		<div class="property-action">
																			<a href="<?php echo base_url();?>vn/page/detail/<?php echo $value_productsnew['id_products'];?>">Xem chi tiết  <i class="fa fa-arrow-circle-o-right"></i></a>
																		</div>
																	</div>
																</div>
															</div>
