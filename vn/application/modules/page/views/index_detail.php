			...
			<div class="row">
				<div class="noo-main col-md-8 right-sidebar" role="main">
					...
					<h1 class="property-title">
					 <span class="property-category"><?php echo $value_detail['name_products_vi'];?></span>
					</h1>
					...
					<div class="property-featured clearfix">
						...
						<h4 class="property-feature-title">Giới Thiệu Sản Phẩm</h4>
						<div class="property-feature-content">
							<?php echo $value_detail['details'];?>
						</div>
					</div>
					<div class="property-feature">
						<h4 class="property-feature-title">Chi Tiết Sản Phẩm</h4>
						<div class="property-feature-content">
									...
									<div class="agent-summary">
										<div class="agent-info">
											...
											<div class="agent-email">
												<i class="fa fa-envelope-square"></i><a class="__cf_email__" href="#" data-cfemail=""> favevietnam@gmail.com</a>
				...
				<div class=" noo-sidebar col-md-4">
					<div class="noo-sidebar-wrapper">
						...
						<div id="noo_property_featured-3" class="widget smk_sidebar_2131 widget_noo_property_featured">
							<h3 class="widget-title">Sản Phẩm Cùng Danh Mục</h3>
								...
								?>
									<li>
										<div class="featured-image">
											<a href="<?php echo base_url();?>vn/page/detail/<?php echo $products_dsitensers['id_products'];?>"><img width="190" height="160" src="<?php echo base_url();?>assets/uploads/<?php echo $products_dsitensers['img'];?>" class="attachment-property-infobox wp-post-image" alt="<?php echo  $products_dsitensers['name_products']?>"/></a>
										</div>
											<h4><a href="<?php echo base_url();?>vn/page/detail/<?php echo $products_dsitensers['id_products'];?>"><?php echo  $products_dsitensers['name_products_vi']?></a></h4>
									</li>
								<?php } ?>	
								</ul>
							</div>
