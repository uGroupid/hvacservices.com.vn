...
class Page extends MY_Controller{
	...
	public function index(){
		$title = "Quạt Công Nghiệp | Quạt Gió Công Nghiệp | hvacservices.com.vn";
	...
	public function news(){
		...
		$title = "News Tin Tức Blog Quạt Công Nghiệp | Quạt Gió Công Nghiệp | hvacservices.com.vn";
	...
	public function view_news($id){
		...
		$title = $valueview_news['name_en']."News Tin Tức Blog Quạt Công Nghiệp | Quạt Gió Công Nghiệp | hvacservices.com.vn";
	...
	public function detail($id){
		...
		$title = $valuedetail['name_products']." Quạt Công Nghiệp | Quạt Gió Công Nghiệp | hvacservices.com.vn";
